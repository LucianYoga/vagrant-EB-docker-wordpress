...
# Set WORDPRESS_ env vars to RDS_ env vars.
export WORDPRESS_DB_HOST="$RDS_HOSTNAME:$RDS_PORT"
export WORDPRESS_DB_USER=$RDS_USERNAME
export WORDPRESS_DB_PASSWORD=$RDS_PASSWORD
export WORDPRESS_DB_NAME=$RDS_DB_NAME
